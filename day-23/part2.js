...
function isRoomClean(amphipods, type) {
  ...
  switch (type) {
    case "A":
      return hasCleanAmp(posStr(3, 2)) && hasCleanAmp(posStr(3, 3)) && hasCleanAmp(posStr(3, 4)) && hasCleanAmp(posStr(3, 5));
      break;
    case "B":
      return hasCleanAmp(posStr(5, 2)) && hasCleanAmp(posStr(5, 3)) && hasCleanAmp(posStr(5, 4)) && hasCleanAmp(posStr(5, 5));
      break;
    case "C":
      return hasCleanAmp(posStr(7, 2)) && hasCleanAmp(posStr(7, 3)) && hasCleanAmp(posStr(7, 4)) && hasCleanAmp(posStr(7, 5));
      break;
    case "D":
      return hasCleanAmp(posStr(9, 2)) && hasCleanAmp(posStr(9, 3)) && hasCleanAmp(posStr(9, 4)) && hasCleanAmp(posStr(9, 5));
      break;
  }
}
...
function whichRoom(x, y) {
  const roomXs = [3, 5, 7, 9];
  const isRoom = roomXs.includes(x) && y >= 2 && y <= 5;
